...
#include <sdkhooks>
#include <clientprefs>
#include <zombiereloaded> //this is purely for displaying when zombies hit human items like whiteknight. I honestly should remove it but whatever :/
#include <colors_csgo>
...
public Plugin myinfo = {
    name = "BossHUD-Modified",
    author = "Strellic/AntiTeal (Author), Koen (Modifications)",
    description = "Plugin that displays boss and breakable health with extended features",
...
void LoadConfig(int id = -1) {
    ...
    //Set default values of bhud config cvars
    g_bShowTopDMG   = true;
    g_bMultBoss     = false;
    g_bMultHP       = false;
